...
const socials: Social[] = [
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/priom-das-731958241/",
    handle: "Priom Das",
    color: "blue",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "Twitter / X",
    url: "https://x.com/PriomDas57",
    handle: "@PriomDas57",
    color: "indigo",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.261 5.633 5.905-5.633zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
      </svg>
    ),
  },
  {
    name: "WhatsApp",
    url: "https://wa.me/8801718843589",
    handle: "+880 1718 843589",
    color: "green",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/priom.das.923",
    handle: "Priom Das",
    color: "fb",
    icon: (
      <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
